...
conn.onopen = (e) => {
    ...
    findGameBtn.addEventListener("click", () => {
        ...
        gameRuleSelect.disabled = true;
        findGameBtn.disabled = true;
        cancelFindBtn.disabled = false;
    ...
    cancelFindBtn.addEventListener("click", () => {
        ...
        gameRuleSelect.disabled = false;
        findGameBtn.disabled = false;
        cancelFindBtn.disabled = true;
        console.log(gameRuleId);
    });
...
function handleFind(data) {
    ...
    switch (type) {
        case "ready":
            handleFindReady(data.data);
            break;
        case "wait":
            handleFindWait(data.data);
            break;
    }
}

function handleFindReady(data) {
    searching = false;
    clearTimeout(remindTimeOut);
